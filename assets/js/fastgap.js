...
Page2Controller.prototype = {
    initialize: function() {
        alert("initialize Page2 Controller, create elementssssss");
    },
    destroy: function() {
...
var EventosController = function() {};

EventosController.prototype = {
    onScroll: Function,
    self: Object,
    initialize: function() {
      self = this;
    ...
    onScroll: function (e) {
      ...
      //the calc
      if (Number(FG.$scrollApp.scrollHeight - e.srcElement.scrollTop) - e.srcElement.clientHeight <= 350) {
        getEventos(document.getElementById('totalRegistros').value, 1);
...
var PosicoesController = function() {};

PosicoesController.prototype = {
    onScroll: Function,
    self: Object,
    initialize: function() {
      self = this;
    ...
    onScroll: function (e) {
      ...
      //the calc
      if (Number(FG.$scrollApp.scrollHeight - e.srcElement.scrollTop) - e.srcElement.clientHeight <= 350) {
        getPosicoes(document.getElementById('totalPosicoes').value, 1);
...
var VeiculosController = function() {};

VeiculosController.prototype = {
    initialize: function() {
